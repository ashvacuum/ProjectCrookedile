...
- **± (Campaign Funds)** - Money cost
- **L (Lagay)** - Corruption cost
- **Origin Currency** - Fear/Clout/Faith/Influence
- **Energy** - Action points

### Card Effects
- **Direct Damage** - Reduce opponent confidence
- **Healing** - Restore your confidence
- **Draw** - Draw additional cards
- **Discard** - Force discard from hand
- **Resource Gain** - Earn ±, L, Support, etc.
- **Heat Modification** - Increase or decrease Heat
- **Utang na Loob** - Build or damage relationships
...
**Navigation:** [<à Home](README.md) | [Game Overview](game_overview.md) | [Origins](origins.md) | [Resources](resources.md)
